...
const NewPage = () => {
  ...
  const submitAction = async () =>{
    ...
    if (formProject.limit_day) formData.append("project_form[limit_day]", formProject.limit_day);
    if (formProject.cost) formData.append("project_form[cost]", formProject.cost);
