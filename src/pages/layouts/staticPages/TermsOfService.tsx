const TermsOfService = () => {
  return (
    <div className="
      ...
      md:max-w-2xl
    ">
      <h1 className="font-bold h1 mt-10 mb-3 text-lg">利用規約</h1>

      <p className="mb-10">
        この利用規約（以下、「本規約」といいます。）は、Cocoaer（以下、「当方」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。
        登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
      </p>
     
      <div className="mb-9">
        <h2 className="font-bold h2 mb-3">第1条（適用）</h2>
        <ol className="list-disc list-outside ml-6 mb-3 space-y-2">
      ...
      <div className="mb-9">
        <h2 className="font-bold h2 mb-3">第2条（利用登録）</h2>
        <ol className="list-disc list-outside ml-6 mb-3 space-y-2">
      ...
      <div className="mb-9">
        <h2 className="font-bold h2 mb-3">第3条（ユーザーIDおよびパスワードの管理）</h2>
        <ol className="list-disc list-outside ml-6 mb-3 space-y-2">
      ...
      <div className="mb-9">
        <h2 className="font-bold h2 mb-3">第4条（禁止事項）</h2>
        <ol className="list-disc list-outside ml-6 mb-3 space-y-2">
      ...
      <div className="mb-9">
        <h2 className="font-bold h2 mb-3">第5条（本サービスの提供の停止等）</h2>
        <ol className="list-disc list-outside ml-6 mb-3 space-y-2">
          ...
          <ol className="list-decimal list-outside ml-6 mb-3 space-y-2">
            ...
            <li>その他、当方が本サービスの提供が困難と判断した合</li>
          </ol>
      ...
      <div className="mb-9">
        <h2 className="font-bold h2 mb-3">第6条（利用制限および登録抹消）</h2>
        <ol className="list-disc list-outside ml-6 mb-3 space-y-2">
          <li>当方は、ユーザーが以下のいずれかに該当する場合には、事前の通知なく、ユーザーに対して、本サービスの全部もしくは一部の利用を制限し、またはユーザーとしての登録を抹消することができるものとします。</li>
          <ol className="list-decimal list-outside ml-6 mb-3 space-y-2">
      ...
      <div className="mb-9 space-y-2">
        <h2 className="font-bold h2 mb-3">第7条（退会）</h2>
        <p>
      ...
      <div className="mb-9">
        <h2 className="font-bold h2 mb-3">第8条（保証の否認および免責事項）</h2>
        <ol className="list-disc list-outside ml-6 mb-3 space-y-2">
          <li>
      ...
      <div className="mb-9 space-y-2">
        <h2 className="font-bold h2 mb-3">第9条（サービス内容の変更等）</h2>
        <p>
      ...
      <div className="mb-9">
        <h2 className="font-bold h2 mb-3">第10条（利用規約の変更）</h2>
        <ol className="list-disc list-outside ml-6 mb-3 space-y-2">
          <li>
      ...
      <div className="mb-9 space-y-2">
        <h2 className="font-bold h2 mb-3">第11条（個人情報の取扱い）</h2>
        <p>
      ...
      <div className="mb-9 space-y-2">
        <h2 className="font-bold h2 mb-3">第12条（通知または連絡）</h2>
        <p>
          ユーザーと当方との間の通知または連絡は、当方の定める方法によって行うものとします。当方はユーザーから当方が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは発信時にユーザーへ到達したものとみなします。
        </p>
      </div>

      <div className="mb-9 space-y-2">
        <h2 className="font-bold h2 mb-3">第13条（権利義務の譲渡の禁止）</h2>
        <p>
      ...
      <div className="mb-9 space-y-2">
        <h2 className="font-bold h2 mb-3">第14条（準拠法・裁判管轄）</h2>
