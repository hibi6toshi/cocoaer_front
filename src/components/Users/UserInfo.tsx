  ...
  return ( 
    <div className="p-6">
      <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-8 md:flex-row">
        <img src={user.avatar?.url ? user.avatar?.url : `${process.env.PUBLIC_URL}/default_avatar.png`} alt="userIcon"  className="self-center flex-shrink-0 w-24 h-24 rounded-full md:justify-self-start" />
